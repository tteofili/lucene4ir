...
public class BM25Similarity extends Similarity {
  ...
  public final long computeNorm(FieldInvertState state) {
    ...
    return encodeNormValue(1, numTerms);
  }
  ...
  public final SimWeight computeWeight(float boost, CollectionStatistics collectionStats, TermStatistics... termStats) {
    ...
    for (int i = 0; i < cache.length; i++) {
      cache[i] = k1 * ((1 - b) + b * boost * decodeNormValue((byte)i) / avgdl);
    }
  ...
  protected class BM25DocScorer extends SimScorer {
    protected final BM25Stats stats;
    protected final float weightValue; // boost * idf * (k1 + 1)
  ...
  protected static class BM25Stats extends SimWeight {
    /** BM25's idf */
