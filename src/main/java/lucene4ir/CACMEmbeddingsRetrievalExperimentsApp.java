 ...
 *
 */
public class CACMEmbeddingsRetrievalExperimentsApp {
  ...
  public static void main(String[] args) throws Exception {
    ...
    for (String directory : directories) {
      ...
      for (File model : models) {
        ...
        IndexerApp.main(new String[] {"params/index/index_params2.xml"});
        RetrievalApp.main(new String[] {"params/retrieval_params2.xml"});
//        ExampleStatsApp.main(new String[] {"params/example_stats_params.xml"});
        ...
        for (String measure : measures) {
          ...
          //in mac oxs
          String command = "/Users/teofili/programs/trec_eval.9.0/trec_eval /Users/teofili/dev/lucene4ir/data/cacm/cacm.qrels /Users/teofili/dev/lucene4ir/data/cacm/wv_results.res -m " + measure;
